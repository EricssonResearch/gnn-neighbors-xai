...
class PGExplainerAlgorithm(ExplainerAlgorithm):
    ...
    def __init__(self, epochs, lr=0.003, **kwargs):
        super().__init__()
        self.epochs = epochs
        self.lr = lr
    ...
    def forward(
        ...
        **kwargs,
        ...
        edge_mask = self._post_process_mask(logits, hard_edge_mask, apply_sigmoid=False)
    ...
    def _concrete_sample(self, logits, temperature=1.0):
